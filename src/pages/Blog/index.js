...
function Blog() {
  ...
  useEffect(() => {
    ...
    const apiUrl = "http://127.0.0.1:3000/posts/api/posts";
  ...
  return (
    <div className={cx("wrapper")}>
      ...
      <div className={cx("blog-content")}>
        {posts.map((post) => (
          <div className={cx("blog-content-item")} key={post.id}>
            <div className={cx("blog-content-top")}>
              <Link
                className={cx("blog-content-top-item")}
              ...
              >
                ...
                <img
                  ...
                  src={`http://127.0.0.1:3000/${post.filePath}`}
                ></img>
              </Link>
            </div>
